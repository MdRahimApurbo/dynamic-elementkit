...
class WPB_Archive_Title_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Archive Title', 'woocommerce-page-builder');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => __('Title HTML Tag', 'woocommerce-page-builder'),
        ...
        $this->add_control(
            'show_breadcrumb',
            [
                'label' => __('Show Breadcrumb', 'woocommerce-page-builder'),
        ...
        $this->start_controls_section(
            'style_title_section',
            [
                'label' => __('Title Style', 'woocommerce-page-builder'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'woocommerce-page-builder'),
        ...
        $this->add_control(
            'title_alignment',
            [
                'label' => __('Alignment', 'woocommerce-page-builder'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'woocommerce-page-builder'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'woocommerce-page-builder'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'woocommerce-page-builder'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', 'woocommerce-page-builder'),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'title_border',
                'label' => __('Border', 'woocommerce-page-builder'),
                'selector' => '{{WRAPPER}} .wpb-archive-title',
            ]
        );
        ...
        $this->add_control(
            'title_border_radius',
            [
                'label' => __('Border Radius', 'woocommerce-page-builder'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Box Shadow', 'woocommerce-page-builder'),
                'selector' => '{{WRAPPER}} .wpb-archive-title',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Breadcrumb Style', 'woocommerce-page-builder'),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'breadcrumb_color',
            [
                'label' => __('Breadcrumb Color', 'woocommerce-page-builder'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function content_template() {
        ...
        <div class="wpb-archive-title-wrapper">
            <h1 class="wpb-archive-title">
                <?php _e('Archive Title', 'woocommerce-page-builder'); ?>
            </h1>
        </div>
        <?php
    }
