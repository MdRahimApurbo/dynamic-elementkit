...
abstract class DEK_Single_Product_Widget_Base extends \Elementor\Widget_Base {
    ...
    protected function register_preview_control() {
        $this->start_controls_section('product_preview_section', [
            'label' => __('Product Preview', 'dynamic-elementkit'),
            'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
        ]);
        $this->add_control('preview_product_id', [
            'label' => __('Preview Product', 'dynamic-elementkit'),
            'type' => \Elementor\Controls_Manager::SELECT2,
            'options' => $this->get_products(),
            'description' => __('Used in Elementor preview only. The live template always uses the current product.', 'dynamic-elementkit'),
        ]);
    ...
    protected function with_product($callback) {
        ...
        if (!$resolved) {
            echo '<p class="wpb-single-product-empty">' . esc_html__('No product is available for preview.', 'dynamic-elementkit') . '</p>';
            return;
        }
...
class DEK_Product_Title_Widget extends DEK_Single_Product_Widget_Base {
    public function get_name() { return 'wpb-product-title'; }
    public function get_title() { return __('Product Title', 'dynamic-elementkit'); }
    public function get_icon() { return 'eicon-product-title'; }
    protected function register_controls() {
        $this->register_preview_control();
        $this->start_controls_section('title_style', ['label' => __('Title', 'dynamic-elementkit'), 'tab' => \Elementor\Controls_Manager::TAB_STYLE]);
        $this->add_control('title_color', ['label' => __('Color', 'dynamic-elementkit'), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .wpb-single-product-title' => 'color: {{VALUE}};']]);
...
class DEK_Product_Price_Widget extends DEK_Single_Product_Widget_Base {
    public function get_name() { return 'wpb-product-price'; }
    public function get_title() { return __('Product Price', 'dynamic-elementkit'); }
    public function get_icon() { return 'eicon-product-price'; }
    protected function register_controls() {
        $this->register_preview_control();
        $this->start_controls_section('price_style', ['label' => __('Price', 'dynamic-elementkit'), 'tab' => \Elementor\Controls_Manager::TAB_STYLE]);
        $this->add_control('price_color', ['label' => __('Color', 'dynamic-elementkit'), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .wpb-single-product-price' => 'color: {{VALUE}};']]);
...
class DEK_Product_Rating_Widget extends DEK_Single_Product_Widget_Base {
    public function get_name() { return 'wpb-product-rating'; }
    public function get_title() { return __('Product Rating', 'dynamic-elementkit'); }
...
class DEK_Product_Short_Description_Widget extends DEK_Single_Product_Widget_Base {
    ...
    protected function register_controls() {
        $this->register_preview_control();
        $this->start_controls_section('description_style', ['label' => __('Description', 'dynamic-elementkit'), 'tab' => \Elementor\Controls_Manager::TAB_STYLE]);
        $this->add_control('text_color', ['label' => __('Color', 'dynamic-elementkit'), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .wpb-single-product-description' => 'color: {{VALUE}};']]);
...
class DEK_Product_Add_To_Cart_Widget extends DEK_Single_Product_Widget_Base {
    public function get_name() { return 'wpb-product-add-to-cart'; }
    public function get_title() { return __('Product Add to Cart / Variations', 'dynamic-elementkit'); }
    ...
    protected function register_controls() {
        $this->register_preview_control();
        $this->start_controls_section('button_style', ['label' => __('Add to Cart', 'dynamic-elementkit'), 'tab' => \Elementor\Controls_Manager::TAB_STYLE]);
        $this->add_control('button_color', ['label' => __('Button Color', 'dynamic-elementkit'), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .wpb-single-product-cart .single_add_to_cart_button' => 'background-color: {{VALUE}};']]);
        $this->add_control('button_text_color', ['label' => __('Text Color', 'dynamic-elementkit'), 'type' => \Elementor\Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .wpb-single-product-cart .single_add_to_cart_button' => 'color: {{VALUE}};']]);
        $this->end_controls_section();
    }
...
class DEK_Product_Meta_Widget extends DEK_Single_Product_Widget_Base {
    public function get_name() { return 'wpb-product-meta'; }
    public function get_title() { return __('Product Meta / Information', 'dynamic-elementkit'); }
...
class DEK_Product_Tabs_Widget extends DEK_Single_Product_Widget_Base {
    public function get_name() { return 'wpb-product-tabs'; }
    public function get_title() { return __('Product Data Tabs', 'dynamic-elementkit'); }
