...
class DEK_Product_Media_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Product Media', 'dynamic-elementkit');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'product_section',
            [
                'label' => __('Product', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'source',
            [
                'label' => __('Source', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'current',
                'options' => [
                    'current' => __('Current Product', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'product_id',
            [
                'label' => __('Select Product', 'dynamic-elementkit'),
        ...
        $this->start_controls_section(
            'video_section',
            [
                'label' => __('Video', 'dynamic-elementkit'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'video_url',
            [
                'label' => __('Video URL', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => '',
                'description' => __('Enter YouTube, Vimeo, or direct MP4/WebM URL.', 'dynamic-elementkit'),
            ]
        );
        ...
        $this->add_control(
            'video_autoplay',
            [
                'label' => __('Autoplay', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'video_muted',
            [
                'label' => __('Muted', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'video_loop',
            [
                'label' => __('Loop', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'video_show_controls',
            [
                'label' => __('Show Controls', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'video_placeholder',
            [
                'label' => __('Placeholder Image', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => '',
                ],
                'description' => __('Show this image before the video plays.', 'dynamic-elementkit'),
            ]
        );
        ...
        $this->start_controls_section(
            'image_section',
            [
                'label' => __('Image', 'dynamic-elementkit'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'image_size',
            [
                'label' => __('Image Size', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'woocommerce_single',
                'options' => [
                    'woocommerce_thumbnail' => __('Thumbnail', 'dynamic-elementkit'),
                    'woocommerce_single' => __('Single', 'dynamic-elementkit'),
                    'medium' => __('Medium', 'dynamic-elementkit'),
                    'large' => __('Large', 'dynamic-elementkit'),
                    'full' => __('Full', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->add_control(
            'image_custom_size',
            [
                'label' => __('Custom Image Size', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => '',
                'description' => __('Enter a custom image size name if your theme supports it.', 'dynamic-elementkit'),
                'condition' => [
                    'image_size' => 'full',
                ],
            ]
        ...
        $this->add_control(
            'show_gallery',
            [
                'label' => __('Show Gallery', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'gallery_columns',
            [
                'label' => __('Gallery Columns', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 4,
                'options' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Gallery Click Action', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'lightbox',
                'options' => [
                    'lightbox' => __('Lightbox', 'dynamic-elementkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Main Image Border Radius', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'gallery_gap',
            [
                'label' => __('Gallery Gap', 'dynamic-elementkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Gallery Item Border Radius', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
    ...
    protected function render() {
        ...
        if (!$product) {
            echo '<p class="wpb-no-product">' . esc_html__('No product selected.', 'dynamic-elementkit') . '</p>';
            return;
        }

        wp_enqueue_style('photoswipe');
        wp_enqueue_style('woocommerce-general');
        wp_enqueue_style('wpb-product-media', DEK_PLUGIN_URL . 'assets/css/product-media.css', [], DEK_VERSION);
        wp_enqueue_script('wpb-product-media', DEK_PLUGIN_URL . 'assets/js/product-media.js', [], DEK_VERSION, true);
    ...
    protected function content_template() {
        ...
        <div class="wpb-product-media">
            <div class="wpb-product-media__viewport">
                <div class="wpb-product-media__container">
                    <div class="wpb-product-media__slide">
                        <img src="<?php echo esc_url(wc_placeholder_img_src()); ?>" alt="<?php esc_attr_e('Product Image', 'dynamic-elementkit'); ?>" class="wpb-media-image" />
                    </div>
                    <div class="wpb-product-media__slide">
                        <img src="<?php echo esc_url(wc_placeholder_img_src()); ?>" alt="<?php esc_attr_e('Product Image', 'dynamic-elementkit'); ?>" class="wpb-media-image" />
                    </div>
