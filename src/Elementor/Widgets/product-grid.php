...
class DEK_Product_Grid_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Product Grid', 'dynamic-elementkit');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'query_section',
            [
                'label' => __('Query', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'query_source',
            [
                'label' => __('Query Source', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'all',
                'options' => [
                    'all' => __('All Products', 'dynamic-elementkit'),
                    'category' => __('By Categories', 'dynamic-elementkit'),
                    'tag' => __('By Tags', 'dynamic-elementkit'),
                    'manual' => __('Manual Selection', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->add_control(
            'product_categories',
            [
                'label' => __('Categories', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'product_tags',
            [
                'label' => __('Tags', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'product_ids',
            [
                'label' => __('Products', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __('Products Per Page', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'order_by',
            [
                'label' => __('Order By', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'date',
                'options' => [
                    'date' => __('Date', 'dynamic-elementkit'),
                    'title' => __('Title', 'dynamic-elementkit'),
                    'price' => __('Price', 'dynamic-elementkit'),
                    'popularity' => __('Popularity', 'dynamic-elementkit'),
                    'rating' => __('Rating', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label' => __('Order', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'desc',
                'options' => [
                    'asc' => __('ASC', 'dynamic-elementkit'),
                    'desc' => __('DESC', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'layout_section',
            [
                'label' => __('Layout', 'dynamic-elementkit'),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'columns',
            [
                'label' => __('Columns', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 4,
                'options' => [
                    1 => __('1', 'dynamic-elementkit'),
                    2 => __('2', 'dynamic-elementkit'),
                    3 => __('3', 'dynamic-elementkit'),
                    4 => __('4', 'dynamic-elementkit'),
                    5 => __('5', 'dynamic-elementkit'),
                    6 => __('6', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->add_control(
            'columns_tablet',
            [
                'label' => __('Columns (Tablet)', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 2,
                'options' => [
                    1 => __('1', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'columns_mobile',
            [
                'label' => __('Columns (Mobile)', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 1,
                'options' => [
                    1 => __('1', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'show_title',
            [
                'label' => __('Show Title', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'show_add_to_cart',
            [
                'label' => __('Show Add To Cart', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'ajax_add_to_cart',
            [
                'label' => __('AJAX Add To Cart', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'show_badge',
            [
                'label' => __('Show Badge', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'badge_text',
            [
                'label' => __('Badge Text', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'auto_sale_badge',
            [
                'label' => __('Auto Sale Badge', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
                'default' => 'no',
                'description' => __('Automatically show "Sale" badge on on-sale products.', 'dynamic-elementkit'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Show Discount Percentage', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
                'default' => 'no',
                'description' => __('Automatically show discount percentage on on-sale products.', 'dynamic-elementkit'),
            ]
        );
        ...
        $this->add_control(
            'button_full_width',
            [
                'label' => __('Full Width Button', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
        ...
        $this->add_control(
            'button_text',
            [
                'label' => __('Button Text', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Add to Cart', 'dynamic-elementkit'),
                'condition' => [
                    'show_add_to_cart' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            'added_button_text',
            [
                'label' => __('Added Button Text', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Added!', 'dynamic-elementkit'),
                'description' => __('Text shown on the button after product is added to cart.', 'dynamic-elementkit'),
                'condition' => [
                    'show_add_to_cart' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => __('Variable Product Button Text', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __('Select options', 'dynamic-elementkit'),
                'condition' => [
                    'show_add_to_cart' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => '',
                'description' => __('Enter a unique Connect ID. Use the same Connect ID in a Category Filter widget to link them.', 'dynamic-elementkit'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'grid_gap',
            [
                'label' => __('Grid Gap', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'product_bg_color',
            [
                'label' => __('Product Background', 'dynamic-elementkit'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Product Border Radius', 'dynamic-elementkit'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Price Typography', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'button_text_color',
            [
                'label' => __('Button Text Color', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_bg_color',
            [
                'label' => __('Button Background', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Button Border Radius', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
    ...
    protected function render() {
        ...
        if (!$products->have_posts()) {
            echo '<p class="wpb-no-products">' . esc_html__('No products found.', 'dynamic-elementkit') . '</p>';
            return;
        }
...
<div class="wpb-product-grid"
              ...
              data-added-button-text="<?php echo esc_attr($settings['added_button_text'] ?? __('Added!', 'dynamic-elementkit')); ?>">
