...
class DEK_Category_Filter_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Category Filter', 'dynamic-elementkit');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_all',
            [
                'label' => __('Show All Button', 'dynamic-elementkit'),
        ...
        $this->add_control(
            'all_label',
            [
                'label' => __('All Button Label', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => 'All',
                'condition' => [
                    'show_all' => 'yes',
        ...
        $this->add_control(
            'filter_style',
            [
                'label' => __('Filter Style', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __('Default', 'dynamic-elementkit'),
                    'outline' => __('Outline', 'dynamic-elementkit'),
                    'fill' => __('Fill', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->add_control(
            'filter_mode',
            [
                'label' => __('Filter Mode', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'single',
                'options' => [
                    'single' => __('Single Select', 'dynamic-elementkit'),
                    'multiple' => __('Multi Select / Checkbox', 'dynamic-elementkit'),
                ],
                'description' => __('Single select allows only one category at a time. Multi select allows multiple categories with checkboxes.', 'dynamic-elementkit'),
            ]
        );
        ...
        $this->add_control(
            'orientation',
            [
                'label' => __('Orientation', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => __('Horizontal', 'dynamic-elementkit'),
                    'vertical' => __('Vertical', 'dynamic-elementkit'),
                ],
            ]
        );
        ...
        $this->add_control(
            'show_count',
            [
                'label' => __('Show Product Count', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'restrict_to_current',
            [
                'label' => __('Restrict to Current Category', 'dynamic-elementkit'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Yes', 'dynamic-elementkit'),
                'label_off' => __('No', 'dynamic-elementkit'),
                'return' => false,
                'default' => 'no',
                'description' => __('When enabled, shows only child categories of the current product category archive.', 'dynamic-elementkit'),
            ]
        );
